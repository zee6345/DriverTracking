...
class EmptyAcivity : AppCompatActivity(), OnMapReadyCallback, PermissionsListener,
    ...
    private fun enableLocationComponent(loadedMapStyle: Style) {
        ...
        if (PermissionsManager.areLocationPermissionsGranted(this)) {
            ...
            val customLocationComponentOptions = LocationComponentOptions.builder(this)
                ...
                .accuracyColor(ContextCompat.getColor(this, R.color.theme_color))
                .build()
...
//            val bm: Bitmap = BitmapFactory.decodeResource(resources, R.drawable.ic_location_marker)
//            map.style?.addImage("place-marker", bm)
            map.style?.addImage("place-marker", ContextCompat.getDrawable(this, R.drawable.ic_location_marker)!!)
